class DispositivoEletronico:
    ...
    def set_qtd_memoria(self):
        nova_qtd_armazenamento = int(input('Digite a nova quantidade de memória (em GB):'))
        while nova_qtd_armazenamento < 0:
            nova_qtd_armazenamento = int(input('Digite a nova quantidade de memória:'))
...
class Smartphone(DispositivoEletronico):
    ...
    def set_qtd_cameras(self):
        nova_qtd_cameras = int(input('Digite quantas câmeras o smartphone tem:'))
